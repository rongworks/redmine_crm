...
[![endorse](https://api.coderwall.com/rongworks/endorsecount.png)](https://coderwall.com/rongworks)
...
== Description
* You can manage companies on a global level (admin) or per-project
...
* Files can be attached to contacts (you must configure a root_project for attachments)
* Companies and Contacts are commentable

* The top panel contains a menu item "CRM" for global management
